...
$(function(){$(".nav-collapse li").click(function(e){e.preventDefault(),$(".nav-collapse li.active").removeClass("active"),$("li",this).addClass("active")}),$(function(){$('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function(e){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var t=$(this.hash);(t=t.length?t:$("[name="+this.hash.slice(1)+"]")).length&&(e.preventDefault(),$("html, body").animate({scrollTop:t.offset().top},800,function(){var e=$(t);if(e.focus(),e.is(":focus"))return!1;e.attr("tabindex","-1"),e.focus()}))}})}),$(document).ready(function(){function e(){$(this).attr("size",$(this).val().length)}$('input[type="text"], input[type="tel"]').keyup(e).each(e),console.clear(),function(){var e=document.querySelectorAll(".expanding"),t=function(e){e.style.height="auto",e.style.overflow="hidden",e.style.height=e.scrollHeight+e.offset+"px",e.style.overflow=""};document.querySelectorAll||(e=function(e,t,a){var o=new Array;t=t||document,a=a||"*";var s=t.getElementsByTagName(a),i=s.length,l=new RegExp("(^|\\s)"+e+"(\\s|$)");for(n=0,j=0;n<i;n++)l.test(s[n].className)&&(o[j]=s[n],j++);return o}("expanding"));for(var n=0;n<e.length;n++)!function(e){e&&(console.log("t.className",e.className),e.offset=window.opera?e.offsetHeight+parseInt(window.getComputedStyle(e,null).getPropertyValue("border-top-width")):e.offsetHeight-e.clientHeight,t(e),e.addEventListener&&(e.addEventListener("input",function(){t(e)}),e.addEventListener("mouseup",function(){t(e)})),e.attachEvent&&e.attachEvent("onkeyup",function(){t(e)}))}(e[n])}()}),$(document).ready(function(){$(".js--how-to-use").waypoint(function(e){$(".js--how-to-use").addClass("animated fadeIn")},{offset:"50%"}),$(".js--heaters-problems").waypoint(function(e){$(".js--heaters-problems").addClass("animated fadeInRight")},{offset:"58%"}),$(".js--img-adv").waypoint(function(e){$(".js--img-adv").addClass("animated fadeInUp")},{offset:"50%"}),$(".js--concl-block-1").waypoint(function(e){$(".js--concl-block-1").addClass("animated fadeInRight")},{offset:"50%"}),$(".js--concl-block-2").waypoint(function(e){$(".js--concl-block-2").addClass("animated fadeInLeft")},{offset:"70%"})})});
